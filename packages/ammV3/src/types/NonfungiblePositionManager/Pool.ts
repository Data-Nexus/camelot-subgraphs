...
export class TickSpacing1 extends ethereum.Event {
  get params(): TickSpacing1__Params {
    return new TickSpacing1__Params(this);
  }
}

export class TickSpacing1__Params {
  _event: TickSpacing1;

  constructor(event: TickSpacing1) {
    this._event = event;
  }
  ...
  get newTickSpacingLimitOrders(): i32 {
    return this._event.parameters[1].value.toI32();
  }
}
...
export class Pool extends ethereum.SmartContract {
  ...
  try_tickSpacing1(): ethereum.CallResult<i32> {
    let result = super.tryCall("tickSpacing", "tickSpacing():(int24)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
...
export class SetTickSpacing1Call extends ethereum.Call {
  get inputs(): SetTickSpacing1Call__Inputs {
    return new SetTickSpacing1Call__Inputs(this);
  }

  get outputs(): SetTickSpacing1Call__Outputs {
    return new SetTickSpacing1Call__Outputs(this);
  }
}

export class SetTickSpacing1Call__Inputs {
  _call: SetTickSpacing1Call;

  constructor(call: SetTickSpacing1Call) {
    this._call = call;
  }
...
export class SetTickSpacing1Call__Outputs {
  _call: SetTickSpacing1Call;
