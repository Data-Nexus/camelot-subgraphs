...
export class Pool extends Entity {
  ...
  set feeZtO(value: BigInt) {
    this.set("feeZtO", Value.fromBigInt(value));
  }
  ...
  set feeOtZ(value: BigInt) {
    this.set("feeOtZ", Value.fromBigInt(value));
  }
...
export class PoolPosition extends Entity {
  ...
  get uncollectedBurnedAmount0(): BigDecimal {
    let value = this.get("uncollectedBurnedAmount0");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set uncollectedBurnedAmount0(value: BigDecimal) {
    this.set("uncollectedBurnedAmount0", Value.fromBigDecimal(value));
  }

  get uncollectedBurnedAmount1(): BigDecimal {
    let value = this.get("uncollectedBurnedAmount1");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set uncollectedBurnedAmount1(value: BigDecimal) {
    this.set("uncollectedBurnedAmount1", Value.fromBigDecimal(value));
  }
...
export class PoolUser extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PoolUser must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("PoolUser", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): PoolUser | null {
    return changetype<PoolUser | null>(
      store.get_in_block("PoolUser", id.toHexString()),
    );
  }

  static load(id: Bytes): PoolUser | null {
    return changetype<PoolUser | null>(store.get("PoolUser", id.toHexString()));
  }
